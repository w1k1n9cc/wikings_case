...
RDEPEND="${COMMON_DEPEND}
	...
	dev-python/PyQt5[${PYTHON_USEDEP},declarative,gui,multimedia,network,printsupport,webkit,webengine,widgets]
	dev-python/sip[${PYTHON_USEDEP}]
	>=dev-python/pyyaml-3.12[${PYTHON_USEDEP}]
	gstreamer? ( dev-qt/qtwebkit:5[gstreamer,multimedia] )
"
